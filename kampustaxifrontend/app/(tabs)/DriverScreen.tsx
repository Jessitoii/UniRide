      ...
      <ScrollView 
        ...
        <View style={styles.balanceCard}>
          <View style={styles.balanceInfo}>
            ...
            <Text style={styles.balanceAmount}>{profile?.wallet?.earningsBalance || 0}₺</Text>
          </View>
          <TouchableOpacity 
            style={styles.balanceButton} 
            onPress={() => navigateToScreen('Wallet')}>
            <Text style={styles.balanceButtonText}>Bakiye Detayları</Text>
        ...
        <View style={styles.actionsContainer}>
          <TouchableOpacity 
            ...
            onPress={() => navigateToScreen('Home', {screen: 'Paylaş'})}>

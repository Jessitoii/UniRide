...
// Define a proper type for the navigation prop
type SearchLocationNavigationProp = CompositeNavigationProp<
  StackNavigationProp<RootStackParamList, 'SearchLocationScreen'>,
...
export default function SearchLocation() {
  ...
  const navigation = useNavigation<SearchLocationNavigationProp>();
  ...
  const handleDoneButtonPress = async () => {
    ...
    if(destinationUniversity && !destinationFaculty) {
      ...
      // @ts-ignore - Navigation params are defined correctly but TypeScript is having trouble with the typing
      navigation.navigate('Home', {screen: 'Yolculuklar', params: {
        destinationUniversity: selectedUniversity,
        destinationFaculty: selectedFaculty,
        userLocation: selectedSuggestion
      }});
    }

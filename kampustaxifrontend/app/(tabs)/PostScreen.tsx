        ...
        return (
          <View style={styles.stepContainer}>
            <View style={{flexDirection: 'row', justifyContent: 'flex-start', alignItems: 'center', width: '100%'}}>
              {/* @ts-ignore */}
              <TouchableOpacity onPress={() => navigation.navigate('Home', {screen: 'Yolculuklar'})}>
        ...
        return (
          <View style={styles.stepContainer}>
            ...
            <View style={styles.locationContainer}>
              ...
              <TouchableOpacity style={styles.button} onPress={handleNextStep} disabled={!selectedRoute || !travelDate || !travelTime || !cost}>
          ...
          <View style={styles.confirmationContainer}>
            ...
            {post && (
              <Post 
                ...
                userLocation={null}
                //@ts-ignore
                onPress={() => {navigation.navigate('PostDetailScreen', {postId: post.id, userLocation: post.userLocation})}}
              />  
            )}
